...
在[硬路由（三）—— 校园网 & 认证方案](https://www.wolai.com/aMfB2ZdTzVYPq5SCHwnT9w "硬路由（三）—— 校园网 & 认证方案")中提到过，玉泉部分宿舍有线网仅限速百兆，这可能与交换机的设置有关。但根据测试，有线网对 IPv6 暂时没有限速。
...
我们在[硬路由（三）—— 校园网 & 认证方案](https://www.wolai.com/aMfB2ZdTzVYPq5SCHwnT9w "硬路由（三）—— 校园网 & 认证方案")当中讲述了使用无线 Client 方式连接 ZJUWLAN-Secure 的办法。接下来，我们需要创建 WWAN6 接口：
