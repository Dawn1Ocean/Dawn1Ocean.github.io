...
笔者于 2024 年 6 月在 pdd 平台购入了一台小米 AX3000T 路由器，花费 140.1 元。它采用了 **Filogic 820** 平台，虽然不支持 Wi-Fi 7，但对于笔者学校宿舍的有线百兆环境来说完全足够。在配置过程当中，笔者发现了它的很多问题，因此暂时不推荐这台机器。详见{% post_link 'Router-6' 'Tricks & 组网图景' %}。
...
8 月左右新版本的 AX3000T 设备（固件版本为 1.0.84 或更高版本）无法安装！请不要参照以下教程！

> 已换用新的硬件（AN8855 交换机），已有 OpenWrt 镜像。详见 [https://www.right.com.cn/forum/thread-8404955-1-1.html](https://www.right.com.cn/forum/thread-8404955-1-1.html)
